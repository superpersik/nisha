...
questions2 = ['Возможно вам подойдут: \n<b>Ящик для рассады</b>. Средний оборот карточки 110 т.р. '
              ...
              '\n<b>Грунт для рассады</b>. Средний оборот карточки 350 т.р.',
              'Возможно вам подойдут: \n<b>Коврики прикроватные</b>. Средний оборот карточки 300 т.р. '
              '\n<b>Палатка двухместная</b>. Средний оборот карточки 350 т.р.\n<b>Полироль для пластика</b>. '
              'Средний оборот карточки 350 т.р.\n<b>Гантели для фитнеса</b>. Средний оборот карточки 400 т.р. '
              '\n<b>Лампа настольная.</b>. Средний оборот карточки 450 т.р.\n<b>Молды для шоколада</b>. '
              'Средний оборот карточки 450 т.р.\n<b>Заколки для волос</b>. Средний оборот карточки 490 т.р.']
...
def result300(message):
    ...
    keyboard = telebot.types.ReplyKeyboardRemove()
    users[chat_id]['q5'] = q5
    bot.send_message(chat_id, text='Вам подойдут следующие ниши:\n<b>1. Дом и хозяйство</b>\nТоповые карточки: '
                                   'коврики прикроватные, чехол для ноутбука.\nСредний оборот от 6 до 26 млн '
                                   '\n<b>2. Дети и воспитание</b>\nТоповые карточки: игрушки антистресс. '
                                   '\nСредний оборот 12 млн\n<b>3. Интерьер и эргономика пространства</b>'
                                   '\nТоповые карточки: вазы.\nСредний оборот 9 млн\n<b>4. Макияж и уход за собой</b> '
                                   '\nТоповые карточки: зеркало для макияжа.\nСредний оборот 20 млн\n<b>5. ЗОЖ</b>'
                                   '\nТоповые карточки: лейкопластырь бактерицидный, паста зубная органическая. '
                                   '\nСредний оборот от 4 до 7 млн\n<b>6. Кулинария</b>\nТоповые карточки: '
                                   'книги по кулинарии, кухонная утварь.\n Средний оборот от 6 до 17 млн'
                                   '\n<b>7. Охота и рыбалка</b> \nТоповые карточки: спиннинг.\n Средний оборот 14 млн',
